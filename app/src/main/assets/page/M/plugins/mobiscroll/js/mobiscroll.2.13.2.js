...
(function ($, window, document, undefined) {
    ...
    ms.classes.Widget = function (el, settings, inherit) {
        //hubo
        this.callBackFn=settings.callBackFn||console.log(settings);
        var $ariaDiv,
            $ctx,
            $header,
            $markup,
        ...
        */
        that.select = function () {
            if (!isModal || that.hide(false, 'set') !== false) {
                ...
                //hubo 回掉函数
                that.callBackFn && that.callBackFn();
            }
        };
    ...
    var ms = $.mobiscroll,
        ...
        preset = function (inst) {
            var orig = $.extend({}, inst.settings),
                ...
                prevent,
                id = this.id + '_dummy',
                inputId=s.inputId||console.log("未传Inputid"),
                lvl = 0,
                ilvl = 0,
                timer = {},
