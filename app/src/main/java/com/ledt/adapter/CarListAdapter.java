...
public class CarListAdapter extends BaseExpandableListAdapter {
    ...
    public int getGroupCount() {
        ...
        if(group!=null&&map!=null){
            Log.e("OOOOO1T",group.toString());
            Log.e("OOOOO1T",map.toString());
        }
...
if(map.get(key.getGroupName()).get(childPosition).getBS()==null){
    holder.lc_state.setText("");
    holder.lc_state.setTextColor(Color.BLACK);
}else if (map.get(key.getGroupName()).get(childPosition).getBS().equals("正常")) {
